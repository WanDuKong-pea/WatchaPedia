...
import WatchedMovie from '../features/user-contents/watched/movie';
import WatchedTV from '../features/user-contents/watched/tv';
...
const WatchedPage: React.FC = () => {
    ...
    return (
        <Base>
            ...
            <Container>
            <BackButton size={30} />
            <TextLogo>Titles you Watched</TextLogo>    
            <ButtonWrapper>
            ...
            <ContentWrapper>
                {isMovie ? <WatchedMovie /> : <WatchedTV />}
            </ContentWrapper>
            </Container>
            </Main>
            <Footer />
