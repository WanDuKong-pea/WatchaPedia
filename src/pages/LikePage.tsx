...
import LikeTV from '../features/user-contents/watched/tv';
import LikeMovie from '../features/user-contents/like/movie';
...
const LikePage: React.FC = () => {
    ...
    return (
        <Base>
            ...
            <Container>
            <BackButton size={30} />
            <TextLogo>Titles you liked</TextLogo>    
            <ButtonWrapper>
